...
function Footer() {
  return (
    <div className='my-20'>
      <div className='text-[250px] font-medium text-center text-slate-800'>GET<span className='text-primary italic'>IN</span>TOUCH</div>
        <div className='flex justify-between items-center mx-12'>
              <div>
                  <Image src={"/meshboc1.png"} width={100} height={100} alt='logo'/>
                  <p className='w-[400px] text-[20px] font-medium'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat, suscipit.</p>
