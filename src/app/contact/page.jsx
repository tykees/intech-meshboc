...
function Page() {
  return (
    <div className='mt-20'>
        <h1 className='text-center text-[36px] font-bold'>Get In Touch with Our Team</h1>
        ...
        <div className='flex justify-center gap-14 items-center'>
            ...
            <Button className="text-white rounded-lg bg-slate-500 hover:bg-primary w-[100%]">devs@intechmeshboc.com</Button>
            </div>
            ...
            <p className='my-3'>Speak with our friendly team</p>
            <Button className="text-white rounded-lg bg-slate-500 hover:bg-primary w-[100%]">+2348105197239</Button>
            </div>
        </div>
    </div>
  )
